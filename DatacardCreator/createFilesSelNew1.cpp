/*
createFilesSelNew1 creates the root files to make the likelihood scans with the 13 kinetic variables 
in the root file "ntuple_RcW_0p3_HS_2.root" (EFT 6th-order operator: cW)


c++ -o createFilesSelNew1 createFilesSelNew1.cpp `root-config --glibs --cflags` 
...
int main (int argc, char** argv) 
{
	...
	//variable width binning for the first 7 variables: met, mjj, mll, ptl1, ptl2, ptj1 (angular vriables excluced)
	...
	for (int k = 0; k < 13; k++) // 13 kinetic variables
	{
